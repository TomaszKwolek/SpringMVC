...
public class BookRestService {
	...
	@RequestMapping(value = "/findAll", method = RequestMethod.GET)
	    public ResponseEntity<List<BookTo>> listAllUsers() {
	 ...
	 @RequestMapping(value = "/findByTitleAndAuthor", method = RequestMethod.GET)
	    public ResponseEntity<List<BookTo>> findById(@RequestParam("title") String title, @RequestParam("author") String author) {
